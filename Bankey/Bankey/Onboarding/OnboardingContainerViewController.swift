...
//  Bankey
//
//  Created by Chou visalroth on 21/12/23.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    private func layout(){
        ...
        // close
        NSLayoutConstraint.activate([
            closeButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 16), // 16 is an example value, adjust as needed
            closeButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 16) // 16 is an example value, adjust as needed
        ])
